...
def test_brainstem_command_happy_path(
    tmp_path, mock_brainstem_segmentation, mock_discover_fs_cases
):
...
def test_brainstem_command_with_threads(
    tmp_path, mock_brainstem_segmentation, mock_discover_fs_cases
):
    input_dir = tmp_path / "in"
    input_dir.mkdir()
...
def test_brainstem_command_args_passed_to_discover(
    tmp_path, mock_brainstem_segmentation, mock_discover_fs_cases
):
    input_dir = tmp_path / "in"
    input_dir.mkdir()
...
def test_brainstem_command_invalid_directory(
    tmp_path, mock_discover_fs_cases, mock_brainstem_segmentation
):
    input_dir = tmp_path / "in"
    input_dir.mkdir()
...
def test_brainstem_command_interrupted(
    tmp_path, mock_brainstem_segmentation, mock_discover_fs_cases
):
    input_dir = tmp_path / "in"
    input_dir.mkdir()
